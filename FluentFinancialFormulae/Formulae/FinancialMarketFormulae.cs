...
/// </summary>
internal static class FinancialMarketsFormulas
{
    /// <summary>
    ...
    internal static decimal CalcRateOfInflation(decimal initialConsumerPriceIndex, decimal endingConsumerPriceIndex)
    {
    ...
    internal static decimal CalcRealRateOfReturn(decimal nominalRate, decimal inflationRate)
    {
