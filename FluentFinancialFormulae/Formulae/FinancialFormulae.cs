namespace FluentFinancialFormulae.Formulae;

    /// <summary>
    /// A collection of methods for solving Finance/Accounting equations.
    /// </summary>
    static class FinancialFormulas
    {
        /*
         * -----------------------------------------------------------------------------
         * | Formulas - Activity                                                       |
        ...
        static decimal CalcAssetTurnover(decimal netSales, decimal totalAssets)
        {
        ...
        static decimal CalcAverageCollectionPeriod(decimal accountsReceivable, decimal annualCreditSales)
        {
        ...
        static decimal CalcCashConversionCycle(decimal inventoryConversionPeriod, decimal receivablesConversionPeriod, decimal payablesConversionPeriod)
        {
        ...
        static decimal CalcInventoryConversionPeriod(decimal inventoryTurnoverRatio)
        {
        ...
        static decimal CalcInventoryConversionRatio(decimal sales, decimal costOfGoodsSold)
        {
        ...
        static decimal CalcInventoryTurnover(decimal sales, decimal averageInventory)
        {
        ...
        static decimal CalcPayablesConversionPeriod(decimal accountsPayable, decimal purchases)
        {
        ...
        static decimal CalcReceivablesConversionPeriod(decimal receivables, decimal netSales)
        {
        ...
        static decimal CalcReceivablesTurnoverRatio(decimal netCreditSales, decimal averageNetReceivables)
        {
        ...
        static decimal CalcAssets(decimal liabilities, decimal equity)
        {
        ...
        static decimal CalcEbit(decimal revenue, decimal operatingExpenses)
        {
        ...
        static decimal CalcEquity(decimal assets, decimal liabilities)
        {
        ...
        static decimal CalcGrossProfit(decimal revenue, decimal costOfGoodsSold)
        {
        ...
        static decimal CalcLiabilities(decimal assets, decimal equity)
        {
        ...
        static decimal CalcNetProfit(decimal grossProfit, decimal operatingExpenses, decimal taxes, decimal interest)
        {
        ...
        static decimal CalcOperatingProfit(decimal grossProfit, decimal operatingExpenses)
        {
        ...
        static decimal CalcSalesRevenue(decimal grossSales, decimal salesOfReturnsAndAllowances)
        {
        ...
        static decimal CalcDebtEquityRatio(decimal totalLiabilities, decimal shareholderEquity)
        {
        ...
        static decimal CalcDebtRatio(decimal totalLiabilities, decimal totalAssets)
        {
        ...
        static decimal CalcDebtServiceCoverageRatio(decimal netOperatingIncome, decimal totalDebtService)
        {
        ...
        static decimal CalcLongTermDebtEquityRatio(decimal longTermLiabilities, decimal equity)
        {
        ...
        static decimal CalcBookValue(decimal acquisitionCost, decimal depreciation)
        {
        ...
        static decimal CalcDecliningBalance(decimal depreciationRate, decimal bookValueAtBeginningOfYear)
        {
        ...
        static decimal CalcUnitsOfProduction(decimal costOfAsset, decimal residualValue, decimal estimatedTotalProduction, decimal actualProduction)
        {
        ...
        static decimal CalcStraightLineMethod(decimal costOfFixedAsset, decimal residualValue, decimal usefulLifeOfAsset)
        {
        ...
        static decimal CalcCashRatio(decimal cash, decimal marketableSecurities, decimal currentLiabilities)
        {
        ...
        static decimal CalcCurrentRatio(decimal currentAssets, decimal currentLiabilities)
        {
        ...
        static decimal CalcOperatingCashFlowRatio(decimal operatingCashFlow, decimal totalDebts)
        {
        ...
        static decimal CalcQuickRatio(decimal currentAssets, decimal inventories, decimal currentLiabilities)
        {
        ...
        static decimal CalcDividendCover(decimal earningsPerShare, decimal dividendsPerShare)
        {
        ...
        static decimal CalcDividendsPerShare(decimal dividendsPaid, decimal numberOfShares)
        {
        ...
        static decimal CalcDividendYield(decimal annualDividendPerShare, decimal pricePerShare)
        {
        ...
        static decimal CalcEarningsPerShare(decimal netEarnings, decimal numberOfShares)
        {
        ...
        static decimal CalcPayoutRatio(decimal dividends, decimal earnings)
        {
        ...
        static decimal CalcPegRatio(decimal pricePerEarnings, decimal annualEpsGrowth)
        {
        ...
        static decimal CalcPriceSalesRatio(decimal pricePerShare, decimal revenuePerShare)
        {
        ...
        static decimal CalcEfficiencyRatio(decimal nonInterestExpense, decimal revenue)
        {
        ...
        static decimal CalcGrossProfitMargin(decimal grossProfit, decimal revenue)
        {
        ...
        static decimal CalcOperatingMargin(decimal operatingIncome, decimal revenue)
        {
        ...
        static decimal CalcProfitMargin(decimal netProfit, decimal revenue)
        {
        ...
        static decimal CalcReturnOnAssets(decimal netIncome, decimal totalAssets)
        {
        ...
        static decimal CalcReturnOnCapital(decimal ebit, decimal taxRate, decimal investedCapital)
        {
        ...
        static decimal CalcReturnOnEquity(decimal netIncome, decimal averageShareholderEquity)
        {
        ...
        static decimal CalcReturnOnNetAssets(decimal netIncome, decimal fixedAssets, decimal workingCapital)
        {
        ...
        static decimal CalcRiskAdjustedReturnOnCapital(decimal expectedReturn, decimal economicCapital)
        {
        ...
        static decimal CalcReturnOnInvestment(decimal gain, decimal cost)
        {
        ...
        static decimal CalcEbitda(decimal ebit, decimal depreciation, decimal amortization)
        {
