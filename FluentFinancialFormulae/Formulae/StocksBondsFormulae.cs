...
namespace FluentFinancialFormulae.Formulae;
    ...
    /// </summary>
    static class StocksBondsFormulas
    {
        /// <summary>
        ...
        static decimal CalcBidAskSpread(decimal bid, decimal ask)
        {
            return ask - bid;
        }
        ...
        static decimal CalcBondEquivalentYield(decimal faceValue, decimal bondPrice, decimal daysToMaturity)
        {
        ...
        static decimal CalcBookValuePerShare(decimal totalCommonStockholdersEquity, decimal numberOfCommonShares)
        {
        ...
        static decimal CalcCapitalAssetPricingModel(decimal riskFreeRate, decimal beta, decimal returnOnTheMarket)
        {
        ...
        static decimal CalcCapitalGainsYield(decimal initialStockPrice, decimal endingStockPrice)
        {
        ...
        static decimal CalcCurrentYield(decimal annualCoupons, decimal currentBondPrice)
        {
        ...
        static decimal CalcDilutedEarningsPerShare(decimal netIncome, decimal averageShares, decimal otherConvertibleInstruments)
        {
        ...
        static decimal CalcDividendPayoutRatio(decimal dividends, decimal netIncome)
        {
        ...
        static decimal CalcDividendYield(decimal dividendsForThePeriod, decimal initialPriceForThePeriod)
        {
        ...
        static decimal CalcDividendsPerShare(decimal dividends, decimal numberOfShares)
        {
        ...
        static decimal CalcEarningsPerShare(decimal netIncome, decimal weightedAverageOutstandingShares)
        {
        ...
        static decimal CalcEquityMultiplier(decimal totalAssets, decimal stockholdersEquity)
        {
        ...
        /// <returns>Decimal value for Equity Multiplier</returns>
        static decimal CalcEquityMultiplier(decimal equityRatio)
        {
        ...
        static decimal CalcEstimatedEarnings(decimal forecastedSales, decimal forecastedExpenses)
        {
        ...
        static decimal CalcEstimatedEarningsWithProfitMargin(decimal projectedSales, decimal projectedNetProfitMargin)
        {
        ...
        static decimal CalcGeometricMeanReturn(ICollection ratesOfReturn)
        {
        ...
        static decimal CalcHoldingPeriodReturn(ICollection percentagePeriodReturns)
        {
        ...
        /// <returns>Decimal value for Holding Period Return</returns>
        static decimal CalcHoldingPeriodReturn(decimal periodicRate, decimal numberOfPeriods)
        {
        ...
        /// <returns>Decimal value for Holding Period Return</returns>
        static decimal CalcHoldingPeriodReturn(decimal earnings, decimal assetAppreciation, decimal initialInvestment)
        {
        ...
        static decimal CalcNetAssetValue(decimal fundAssets, decimal fundLiabilities, decimal outstandingShares)
        {
        ...
        static decimal CalcPreferredStockValue(decimal dividend, decimal discountRate)
        {
        ...
        static decimal CalcRateOfReturn(decimal dividend, decimal price)
        {
        ...
        static decimal CalcPriceToBookValueRatio(decimal marketPricePerShare, decimal bookValuePerShare)
        {
        ...
        static decimal CalcPriceToEarningsRatio(decimal pricePerShare, decimal earningsPerShare)
        {
        ...
        static decimal CalcPriceToSalesRatio(decimal pricePerShare, decimal salesPerShare)
        {
        ...
        static decimal CalcRiskPremium(decimal assetOrInvestmentReturn, decimal riskFreeReturn)
        {
        ...
        static decimal CalcStockPresentValueWithConstantGrowth(decimal estimatedDividendsForNextPeriod, decimal requiredRateOfReturn, decimal growthRate)
        {
        ...
        static decimal CalcGrowthRate(decimal retentionRate, decimal returnOnEquity)
        {
        ...
        static decimal CalcRequiredRateOfReturn(decimal dividendYield, decimal growthRate)
        {
        ...
        static decimal CalcStockPresentValueWithZeroGrowth(decimal dividendsPerPeriod, decimal requiredRateOfReturn)
        {
        ...
        static decimal CalcTaxEquivalentYield(decimal taxFreeYield, decimal taxRate)
        {
        ...
        static decimal CalcTotalStockReturnPercentage(decimal initialStockPrice, decimal endingStockPrice, decimal dividends)
        {
        ...
        static decimal CalcTotalStockReturnCash(decimal initialStockPrice, decimal endingStockPrice, decimal dividends)
        {
        ...
        static decimal CalcTotalStockReturnFromYields(decimal dividendYield, decimal capitalGainsYield)
        {
        ...
        static decimal CalcApproxYieldToMaturity(decimal couponOrInterestPayment, decimal faceValue, decimal price, decimal yearsToMaturity)
        {
        ...
        static decimal CalcZeroCouponBondValue(decimal faceValue, decimal rateOrYield, decimal timeToMaturity)
        {
        ...
        static decimal CalcZeroCouponBondYield(decimal faceValue, decimal presentValue, decimal timeToMaturity)
        {
