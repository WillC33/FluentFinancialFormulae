namespace FluentFinancialFormulae.Formulae;
    ...
    static class BankingFormulae
    {
        ...
        static decimal CalcCompoundInterest(decimal principal, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcContinuousCompounding(decimal principal, decimal rate, decimal time)
        {
        ...
        static decimal CalcDebtToIncomeRatio(decimal monthlyDebtPayments, decimal grossMonthlyIncome)
        {
        ...
        static decimal CalcBalloonBalanceOfLoan(decimal presentValue, decimal payment, decimal ratePerPayment, decimal numberOfPayments)
        {
        ...
        static decimal CalcLoanPayment(decimal presentValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcRemainingBalanceOnLoan(decimal presentValue, decimal payment, decimal ratePerPayment, decimal numberOfPayments)
        {
            return presentValue * (decimal)Math.Pow((double)(1 + ratePerPayment), (double)numberOfPayments)
                - payment * ((decimal)(Math.Pow((double)(1 + ratePerPayment), (double)numberOfPayments) - 1) / ratePerPayment);
        }
        ...
        static decimal CalcLoanToDepositRatio(decimal loans, decimal deposits)
        {
        ...
        static decimal CalcLoanToValueRatio(decimal loanAmount, decimal valueOfCollateral)
        {
        ...
        static decimal CalcSimpleInterest(decimal principal, decimal rate, decimal time)
        {
        ...
        static decimal CalcSimpleInterestRate(decimal principal, decimal interest, decimal time)
        {
        ...
        static decimal CalcSimpleInterestPrincipal(decimal interest, decimal rate, decimal time)
        {
        ...
        static decimal CalcSimpleInterestTime(decimal principal, decimal interest, decimal rate)
        {
