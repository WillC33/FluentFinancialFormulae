namespace FluentFinancialFormulae.Formulae;
    ...
    /// </summary>
    static class GeneralFinanceFormulas
    {
        /// <summary>
        ...
        static decimal CalcFutureValueOfAnnuity(decimal periodicPayment, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcFutureValueOfAnnuityWithContinuousCompounding(decimal cashFlow, decimal rate, decimal time)
        {
        ...
        static decimal CalcNumberOfPeriodsForFutureValueOfAnnuity(decimal futureValueOfAnnuity, decimal rate, decimal payment)
        {
        ...
        static decimal CalcAnnuityPaymentPresentValue(decimal presentValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcAnnuityPaymentFutureValue(decimal futureValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcNumberOfPeriodsForPresentValueOfAnnuity(decimal presentValueOfAnnuity, decimal rate, decimal payment)
        {
        ...
        static decimal CalcPresentValueOfAnnuity(decimal periodicPayment, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcAverageCollectionPeriod(decimal receivableTurnover)
        {
        ...
        static decimal CalcPresentValueAnnuityFactor(decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcPresentValueOfAnnuityDue(decimal periodicPayment, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcFutureValueOfAnnuityDue(decimal periodicPayment, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcAnnuityDuePaymentUsingPresentValue(decimal presentValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcAnnuityDuePaymentUsingFutureValue(decimal futureValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcDoublingTime(decimal rateOfReturn)
        {
        ...
        static decimal CalcDoublingTimeWithContinuousCompounding(decimal rate)
        {
        ...
        /// <param name="rate">Rate</param>
        /// <returns>Decimal value for Doubling Time</returns>
        static decimal CalcDoublingTimeForSimpleInterest(decimal rate)
        {
            return 1 / rate;
        }
        ...
        static decimal CalcFutureValue(decimal initialCashFlow, decimal rateOfReturn, decimal numberOfPeriods)
        {
        ...
        static decimal CalcFutureValueWithContinuousCompounding(decimal presentValue, decimal rate, decimal time)
        {
        ...
        static decimal CalcFutureValueFactor(decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcFutureValueOfGrowingAnnuity(decimal firstPayment, decimal ratePerPeriod, decimal growthRate, decimal numberOfPeriods)
        {
        ...
        static decimal CalcGrowingAnnuityPaymentFromPresentValue(decimal presentValue, decimal ratePerPeriod, decimal growthRate, decimal numberOfPeriods)
        {
        ...
        /// <param name="numberOfPeriods">Number of Periods</param>
        /// <returns>Decimal value for Growing Annuity Payment</returns>
        static decimal CalcGrowingAnnuityPaymentFromFutureValue(decimal futureValue, decimal ratePerPeriod, decimal growthRate, decimal numberOfPeriods)
        {
        ...
        static decimal CalcPresentValueOfGrowingAnnuity(decimal firstPayment, decimal ratePerPeriod, decimal growthRate, decimal numberOfPeriods)
        {
        ...
        static decimal CalcPresentValueOfGrowingPerpetuity(decimal dividendOrCouponAtFirstPeriod, decimal discountRate, decimal growthRate)
        {
        ...
        static decimal CalcNumberOfPeriodsForPresentValueToReachFutureValue(decimal futureValue, decimal presentValue, decimal ratePerPeriod)
        {
        ...
        static decimal CalcPresentValueOfPerpetuity(decimal dividendOrCouponPerPeriod, decimal discountRate)
        {
        ...
        static decimal CalcPresentValue(decimal cashFlowAfterFirstPeriod, decimal rateOfReturn, decimal numberOfPeriods)
        {
        ...
        static decimal CalculatePresentValueWithContinuousCompounding(decimal cashFlow, decimal rate, decimal time)
        {
        ...
        static decimal CalcPresentValueFactor(decimal rateOfReturn, decimal numberOfPeriods)
        {
        ...
        static decimal CalcRuleOf72(decimal rate)
        {
            return 72 / (rate * 100);
        }
        ...
        static decimal CalcRateRequiredToDoubleByRuleOf72(decimal lengthOfTime)
        {
        ...
        static decimal CalcWeightedAverage(ICollection<KeyValuePair<decimal, decimal>> relativeWeightsAndValues)
        {           
            decimal sumTotal = 0;
