...
namespace FluentFinancialFormulae.Formulae;
    ...
    /// </summary>
    static class CorporateFormulas
    {
        /// <summary>
        ...
        static decimal CalcAssetToSalesRatio(decimal totalAssets, decimal salesRevenue)
        {
        ...
        static decimal CalcAssetTurnoverRatio(decimal salesRevenue, decimal totalAssets)
        {
        ...
        static decimal CalcAverageCollectionPeriod(decimal receivablesTurnover)
        {
        ...
        static decimal CalcContributionMargin(decimal pricePerProduct, decimal variableCostPerProduct)
        {
        ...
        static decimal CalcDaysInInventory(decimal inventoryTurnover)
        {
        ...
        static decimal CalcDebtCoverageRatio(decimal netOperatingIncome, decimal debtService)
        {
        ...
        static decimal CalcDebtToEquityRatio(decimal totalLiabilities, decimal totalEquity)
        {
        ...
        static decimal CalcDiscountedPaybackPeriod(decimal initialInvestment, decimal rate, decimal periodicCashFlow)
        {
        ...
        static decimal CalcEquivalentAnnualAnnuity(decimal netPresentValue, decimal ratePerPeriod, decimal numberOfPeriods)
        {
        ...
        static decimal CalcFreeCashFlowToEquity(decimal netIncome, decimal depreciationAndAmortization, decimal capitalExpenditure, decimal changeInWorkingCapital, decimal netBorrowing)
        {
        ...
        static decimal CalcFreeCashFlowToFirm(decimal ebit, decimal taxRate, decimal depreciationAndAmortization, decimal capitalExpenditure, decimal changeInWorkingCapital)
        {
        ...
        static decimal CalcInterestCoverageRatio(decimal ebit, decimal interestExpense)
        {
        ...
        static decimal CalcInventoryTurnoverRatio(decimal sales, decimal inventory)
        {
        ...
        static decimal CalcNetPresentValue(decimal initialInvestment, ICollection cashFlows, decimal discountRate)
        {
            decimal sumTotal = 0;
            int count = 1;
        ...
        static decimal CalcNetProfitMargin(decimal netIncome, decimal salesRevenue)
        {
        ...
        static decimal CalcNetWorkingCapital(decimal currentAssets, decimal currentLiabilities)
        {
            return currentAssets - currentLiabilities;
        }
        ...
        static decimal CalcPaybackPeriod(decimal initialInvestment, decimal periodicCashFlow)
        {
        ...
        static decimal CalcQuickRatio(decimal quickAssets, decimal currentLiabilities)
        {
        ...
        static decimal CalcReceivablesTurnoverRatio(decimal salesRevenue, decimal averageAccountsReceivable)
        {
        ...
        static decimal CalcRetentionRatio(decimal netIncome, decimal dividends)
        {
        ...
        static decimal CalcReturnOnAssets(decimal netIncome, decimal averageTotalAssets)
        {
        ...
        static decimal CalcReturnOnEquity(decimal netIncome, decimal averageStockholdersEquity)
        {
        ...
        static decimal CalcReturnOnInvestment(decimal earnings, decimal initialInvestment)
        {
